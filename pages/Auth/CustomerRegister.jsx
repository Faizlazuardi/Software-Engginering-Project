export default function Register() {
    return (
        <div className="flex flex-col justify-center items-center gap-5 bg-gray-100 w-screen h-screen">
            <div className="flex flex-col justify-center items-center gap-4 bg-white p-8 border-2 rounded-lg w-128 h-160">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <button className="bg-black rounded-md w-110 h-10 text-white" type="submit">Sign Up</button>
                </div>
            </div>
            ...
            <p>Already have an account? <strong><a href="/login">Sign In</a></strong></p>
        </div>
    );
}